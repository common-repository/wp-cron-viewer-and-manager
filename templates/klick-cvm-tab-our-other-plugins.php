<!-- Second Tab content -->
<div id="klick_cvm_tab_second">
	<h1><img src="<?php echo KLICK_CVM_PLUGIN_URL . '/images/klick-on-it.png'; ?>"> <?php _e('Our new and upcoming plugins', 'klick-cvm'); ?></h1>
	<br>
	<ul class="cvm-plugin-list">
		<?php 
		...
		foreach ($logo_links as $key => $value) { ?>
			<li>
				<img src="<?php echo KLICK_CVM_PLUGIN_URL . '/images/our-more-plugins/' . $value['link_logo'] . '.svg';?>">
				<h4><a href="http://klick-on-it.com/wordpress-plugins/<?php echo $value['link_name']; ?>"><?php _e('Visit here', 'klick-cvm'); ?></a></h4>
			</li>	
		<?php } ?>
	</ul>
</div>
