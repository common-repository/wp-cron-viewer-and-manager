...
if (class_exists('Klick_Cvm_Notifier')) return;

/**
 * Class Klick_Cvm_Notifier
 */
class Klick_Cvm_Notifier {
	...
	/**
	 * Klick_Cvm_PHP_Notifier constructor
	...
	public function __construct() {
		...
		$folder = opendir(KLICK_CVM_PLUGIN_MAIN_PATH . 'notices');
	...
	public function add_noitice($notice_file) {
		...
		$notice_file = KLICK_CVM_PLUGIN_MAIN_PATH . 'notices' . '/' . $notice_file;
